        ...
        <>
            ...
            <Row style={{margin: '20px 0 40px'}}>
                <Col span={20} offset={2}>
                    <h1 className='slide-heading'>Организационно-распорядительные документы по вопросам охраны окружающей среды на предприятии</h1>
                </Col>
            </Row>
                ...
                <Col span={9} offset={1}>
                    <Tabs animated centered tabPosition={'top'} defaultActiveKey='2' style={{display: 'flex', justifyContent: 'space-around'}}>
                        <TabPane tab={<span style={{fontSize: '20px', color: 'green'}}>Документация в общем виде</span>} key="1">
                            <>
                                <h2 style={{marginBottom: '20px'}}>В общем виде документация может быть:</h2>
