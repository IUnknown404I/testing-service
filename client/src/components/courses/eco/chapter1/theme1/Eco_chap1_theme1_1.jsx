    ...
    return (
        <>
            ...
            <Row style={{margin: '20px 0'}}>
                ...
                <Col offset={2} span={20} className='eco-inv-card eco-container-left-border eco-container-right-border' style={{padding: '35px 10px'}}>
                    <Row>
                        <Col span={11} offset={1}>
                            <h1 style={{textAlign: 'center'}}>
                                <Popover
                                    ...
                                    title=''
                                    trigger="hover">
                                    <strong>Загрязняющие вещества</strong>
                                </Popover>
                                &nbsp;определяются:
                            </h1>
                            <Carousel style={{border: '2px solid green', borderRadius: '5px'}} autoplay appendDots={(dots) => <ul>{dots}</ul>}>
