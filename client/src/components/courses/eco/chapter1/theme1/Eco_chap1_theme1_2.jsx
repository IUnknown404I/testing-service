            ...
            <Row>
                ...
                <Col span={13} offset={0} className='eco-img-col'>
                    <Steps progressDot direction="vertical" className='eco-steps-style'>
                        ...
                        <Step status={'process'} title="Органы исполнительной власти Российской Федерации и органы государственной власти субъектов Российской Федерации могут вводить ограничения использования нефтепродуктов и других видов топлива, сжигание которых приводит к загрязнению атмосферного воздуха на соответствующей территории, а также стимулировать производство и применение экологически безопасных видов топлива и других энергоносителей." />
                        <Step status={'process'} title="Запрещается выброс в атмосферный воздух веществ, степень опасности которых для жизни и здоровья человека и для окружающей среды не установлена." />
                        <Step status={'process'} title="Действия, направленные на изменение состояния атмосферного воздуха и атмосферных явлений, могут осуществляться только при отсутствии вредных последствий для жизни и здоровья человека и для окружающей среды и на основании разрешений, выданных федеральным органом исполнительной власти в области охраны окружающей среды." />
                    </Steps>
                </Col>
            </Row>
