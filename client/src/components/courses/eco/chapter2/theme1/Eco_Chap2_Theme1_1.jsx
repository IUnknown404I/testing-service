                    ...
                    <Card className='simple-card'>
                        ...
                        <div className='eco-img-div-item extra' style={{marginTop: '30px'}}>
                            ...
                            <span style={{fontSize: '16px'}}>
                                При осуществлении производственного экологического контроля измерения выбросов в обязательном порядке производятся в отношении загрязняющих веществ, <strong style={{fontSize: '16px'}}>характеризующих применяемые технологии и особенности производственного процесса</strong> на объекте (маркерные вещества).
                            </span>
                        </div>
                    </Card>
