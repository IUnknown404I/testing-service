                            ...
                            <div>
                                <div className='eco-slider-card'>
                                    <div style={{marginBottom: '20px'}}>
                                        <div>
                                            <h1 style={{textAlign: "center", fontSize: '1.65rem', margin: '20px 0 30px'}}>
                                                <ExclamationCircleOutlined style={{color: 'darkorange', fontSize: '23px'}}/>&nbsp; <strong>Плата за размещение отходов</strong>
                                            </h1>
                                        </div>

                                        <div className='eco-flex-row' style={{justifyContent: 'space-around', padding: '10px 2%'}}>
                                            <div className='eco-carousel-container' style={{width: '46%'}}>
                                                <div>
                                                    <div>
                                                ...
                                                <Button block className='mybut' onClick={() => setShowModal(true)}>Плата при размещении отходов</Button>
                                            ...
                                            <div className='eco-carousel-container' style={{width: '50%'}}>
                            ...
                            <div>
                                <div className='eco-slider-card'>
                                    <div style={{marginBottom: '10px'}}>
                                        ...
                                        <div className='eco-flex-row' style={{justifyContent: 'center', padding: '10px 2%'}}>
                                            <div className='eco-img-col' style={{width: '38%'}}>
                                                <Image
                                                    width={450}
                                                    src={'/images/vix.jpg'}
                                                    preview={false}
                                            ...
                                            <div style={{width: '58%', textAlign: 'left'}} className='eco-flex-col eco-img-col'>
                                                <div className='eco-container-left-border'>
                                                    ...
                                                    <h1 style={{fontSize: '1.3rem'}}><strong>3. Несвоевременное или неполное внесение</strong> лицом, обязанным вносить плату, платы влечет за собой уплату пеней в размере&nbsp;
                                                        ...
                                                        на день уплаты пеней ключевой ставки Банка России. Пеня начисляется за каждый календарный день просрочки исполнения обязанности по внесению платы.</h1>
                                                </div>
                                            </div>
                                        </div>
